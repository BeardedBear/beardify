        ...
        , div [ class "Device" ]
            [ div [ class "DeviceSelect" ]
                ...
                , div [ class "DeviceSelect__menu" ]
                    [ div [ class "DeviceSelect__item active" ]
                        [ i [ class "DeviceSelect__icon icon icon-computer" ] []
                        , div []
                            [ div [ class "DeviceSelect__label" ] [ text "This computer" ]
                            , div [ class "DeviceSelect__id" ] [ text "XPS-DELL-germain" ]
                            ]
                        ]
                    , div [ class "DeviceSelect__item" ]
                        [ i [ class "DeviceSelect__icon icon icon-smartphone" ] []
                        , div []
                            [ div [ class "DeviceSelect__label" ] [ text "Mobile" ]
                            , div [ class "DeviceSelect__id" ] [ text "Mobile" ]
                            ]
                        ]
                    ]
                ]
