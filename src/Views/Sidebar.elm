        ...
        [ div [ class "Sidebar__item" ]
            ...
            , div [ class "Sidebar__collections HelperScrollArea" ]
                [ ul [ class "HelperScrollArea__target List unstyled" ]
                    [ li [ class "List__item" ] [ i [ class "List__icon icon-collection" ] [], text "Abricot" ]
                    , li [ class "List__item" ] [ i [ class "List__icon icon-collection" ] [], text "Ananas" ]
                    , li [ class "List__item" ] [ i [ class "List__icon icon-collection" ] [], text "Citron" ]
                    , li [ class "List__item" ] [ i [ class "List__icon icon-collection" ] [], text "Fruit de la passion" ]
