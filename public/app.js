...
var author$project$Data$Session$defaultStore = {counter: 0};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'counter',
				elm$json$Json$Encode$int(v.counter))
			]));
};
...
var author$project$Page$Counter$init = function (session) {
	return _Utils_Tuple3(session.store.counter, session, elm$core$Platform$Cmd$none);
};
var author$project$Page$Home$ReadmeReceived = function (a) {
...
var author$project$Request$Github$getReadme = F2(
...
var author$project$Page$Home$init = function (session) {
	return _Utils_Tuple3(
		...
		session,
		A2(author$project$Request$Github$getReadme, session, author$project$Page$Home$ReadmeReceived));
};
...
var author$project$Main$init = F3(
	function (flags, url, navKey) {
		...
		return A2(
			...
			{page: author$project$Main$Blank, session: session});
	});
		...
		if (msg.a.$ === 'Ok') {
			...
			return _Utils_Tuple3(
				_Utils_update(
					model,
					{
						readme: author$project$Page$Home$errorToMarkdown(error)
					}),
				session,
				elm$core$Platform$Cmd$none);
		}
...
var author$project$Page$Counter$Dec = {$: 'Dec'};
var author$project$Page$Counter$Inc = {$: 'Inc'};
var author$project$Page$Counter$Reset = {$: 'Reset'};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onClick(author$project$Page$Counter$Dec)
								]),
							_List_fromArray(
								[
									elm$html$Html$text('-')
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onClick(author$project$Page$Counter$Inc)
								]),
							_List_fromArray(
								[
									elm$html$Html$text('+')
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onClick(author$project$Page$Counter$Reset)
								]),
							_List_fromArray(
								[
...
var author$project$Page$Home$view = F2(
	function (_n0, model) {
		return _Utils_Tuple2(
			...
			_List_fromArray(
				[
					A2(elm_explorations$markdown$Markdown$toHtml, _List_Nil, model.readme)
				]));
	});
...
var author$project$Views$Page$Counter = {$: 'Counter'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('elm-kitchen')
					])),
				A2(
				elm$html$Html$nav,
				_List_Nil,
				_List_fromArray(
					[
						A3(linkIf, author$project$Views$Page$Home, author$project$Route$Home, 'Home'),
						elm$html$Html$text(' | '),
						A3(linkIf, author$project$Views$Page$Counter, author$project$Route$Counter, 'Second page')
					])),
				A2(
				elm$html$Html$a,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('GithubIcon'),
						elm$html$Html$Attributes$target('_blank'),
						elm$html$Html$Attributes$href('https://github.com/allo-media/elm-kitchen')
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$Main$view = function (_n0) {
	...
	switch (page.$) {
		...
		case 'CounterPage':
			...
			return A2(
				author$project$Views$Page$frame,
				pageConfig(author$project$Views$Page$Counter),
				A2(
					mapMsg,
