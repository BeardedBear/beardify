...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var timestamp = elm$time$Time$millisToPosix(flags.now);
		return _Utils_Tuple2(
			{
				config: {
					currentDate: {
						day: A2(elm$time$Time$toDay, elm$time$Time$utc, timestamp),
						hour: A2(elm$time$Time$toHour, elm$time$Time$utc, timestamp),
						milliSecond: A2(elm$time$Time$toMillis, elm$time$Time$utc, timestamp),
						minute: A2(elm$time$Time$toMinute, elm$time$Time$utc, timestamp),
						month: A2(elm$time$Time$toMonth, elm$time$Time$utc, timestamp),
						second: A2(elm$time$Time$toSecond, elm$time$Time$utc, timestamp),
						year: A2(elm$time$Time$toYear, elm$time$Time$utc, timestamp)
					},
					openedMenu: false,
					token: flags.token
				},
...
var author$project$Root$PlayerVolume = function (a) {
	return {$: 'PlayerVolume', a: a};
};
var author$project$Root$PlayerVolumeToogleMute = function (a) {
	return {$: 'PlayerVolumeToogleMute', a: a};
};
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('active', !player.device.volume_percent)
											])),
										(player.device.volume_percent > 0) ? elm$html$Html$Events$onClick(
										author$project$Root$PlayerVolumeToogleMute('0')) : elm$html$Html$Events$onClick(
										author$project$Root$PlayerVolumeToogleMute('100'))
									]),
								_List_fromArray(
									[
										A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onInput(author$project$Root$PlayerVolume)
									]),
								_List_Nil),
								A2(
								elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Attributes$style,
												'width',
												elm$core$String$fromFloat(player.device.volume_percent) + '%'),
												elm$html$Html$Attributes$class('progress-current')
											]),
										_List_Nil)
									]))
									...
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2(
												'currently-playing',
												A2(elm$core$List$member, e.artist, currentArtists))
											]))
									]),
								_List_fromArray(
									[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('icon-question')
							]),
						_List_Nil),
						A2(
						elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('SHIFT + F : Focus search bar')
									])),
								A2(
								elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										elm$html$Html$text('SPACEBAR : Play/Pause player')
									]))
							]))
					]))
			]));
...
var author$project$Data$Playlist$PlaylistPaging = F2(
	function (items, next) {
...
var author$project$Data$Playlist$decodePlaylistPaging = A3(
	elm$json$Json$Decode$map2,
...
var author$project$Request$getPaging = F3(
	function (url, decoder, token) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: elm$http$Http$expectJson(decoder),
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'SetCollection':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						(1 === 1) ? elm$core$Platform$Cmd$batch(_List_Nil) : elm$core$Platform$Cmd$batch(_List_Nil));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'GetPlaylist':
						...
						elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									elm$http$Http$send,
									author$project$Root$SetPlaylistTracks,
									A3(author$project$Request$getPaging, e.next, author$project$Data$Playlist$decodePlaylistPaging, token))
								])));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			...
			case 'PlayerVolume':
				...
				return _Utils_Tuple2(
					...
					A2(
						elm$http$Http$send,
						author$project$Root$PlayerControl,
						A4(author$project$Request$put, 'volume?volume_percent=', e, '', token)));
			case 'PlayerVolumeToogleMute':
				var e = msg.a;
				return _Utils_Tuple2(
					model,
					A2(
			...
			case 'HandleKeyboardEvent':
				var event = msg.a;
				var _n1 = _Utils_Tuple2(event.shiftKey, event.key);
				_n1$3:
				while (true) {
					if (_n1.b.$ === 'Just') {
						switch (_n1.b.a) {
							case 'Escape':
								return _Utils_Tuple2(
									...
									elm$core$Platform$Cmd$none);
							case ' ':
								return (player.is_playing && (model.searchModel.searchQuery === '')) ? _Utils_Tuple2(
									model,
									A2(
										elm$http$Http$send,
										author$project$Root$PlayerControl,
										A4(author$project$Request$put, '', 'pause', '', token))) : _Utils_Tuple2(
									model,
									A2(
										elm$http$Http$send,
										author$project$Root$PlayerControl,
								...
								if (_n1.a) {
									return _Utils_Tuple2(
										...
										A2(
											elm$core$Task$attempt,
											function (_n2) {
												return author$project$Root$NoOp;
											},
											elm$browser$Browser$Dom$focus('search')));
								} else {
									break _n1$3;
								}
							default:
